    ...
    extends Service
{
    ...
    public WeatherBugWebServices(WebServiceFeature... features) {
        super(__getWsdlLocation(), WEATHERBUGWEBSERVICES_QNAME, features);
    }

    public WeatherBugWebServices(URL wsdlLocation) {
        super(wsdlLocation, WEATHERBUGWEBSERVICES_QNAME);
    }

    public WeatherBugWebServices(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, WEATHERBUGWEBSERVICES_QNAME, features);
    }
    ...
    public WeatherBugWebServices(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
