 ...
 * @author nwtis_2
 */
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"/privatno/*", "/IspisKorisnika", "/IspisAktivnihKorisnika"}, dispatcherTypes = {DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.REQUEST, DispatcherType.INCLUDE})
