 ...
 * 
 */
@WebServiceClient(name = "MeteoWS", targetNamespace = "http://serveri.ws.lurajcevi.nwtis.foi.org/", wsdlLocation = "http://localhost:8084/lurajcevi_zadaca_3_1/MeteoWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName METEOWS_QNAME = new QName("http://serveri.ws.lurajcevi.nwtis.foi.org/", "MeteoWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/lurajcevi_zadaca_3_1/MeteoWS?wsdl");
    ...
    public MeteoWS getMeteoWSPort() {
        return super.getPort(new QName("http://serveri.ws.lurajcevi.nwtis.foi.org/", "MeteoWSPort"), MeteoWS.class);
    }
    ...
    public MeteoWS getMeteoWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serveri.ws.lurajcevi.nwtis.foi.org/", "MeteoWSPort"), MeteoWS.class, features);
    }
